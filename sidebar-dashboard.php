...
<div id="sidebar" class="large-4 columns dashboard-side">
	...
	<div class="sidebar-widget-wrap cf">
		...
		<div class="dashboard-user-meta cf">
			...
			<div class="edit-profile"><?php echo html_link( appthemes_get_edit_profile_url(), __( 'Editar Perfil', APP_TD ) ); ?></div>
		</div>

		<?php if ( current_user_can('edit_projects') ): ?>
			<div class="add-project cf"><span>+</span><?php echo html_link( get_the_hrb_project_create_url(), __( 'Nueva Consulta', APP_TD ) ); ?></div>
		<?php endif; ?>

		<aside id="dashboard-side-nav">
			<div class="section-head">
				<h3><?php _e( 'Tablero', APP_TD ); ?></h3>
			</div>

			<ul class="dashboard-links">
				<li class="notifications <?php hrb_dashboard_current_page_class('dashboard'); ?>">
					<a href="<?php echo esc_url( hrb_get_dashboard_url_for() ); ?>"><?php echo __( 'Recientes', APP_TD ); ?></a><span>&nbsp;</span>
				</li>
				<li class="notifications <?php hrb_dashboard_current_page_class('notifications'); ?>">
					<a href="<?php echo esc_url( hrb_get_dashboard_url_for('notifications') ); ?>"><?php echo __( 'Notificaciones', APP_TD ); ?><span><?php echo sprintf( ' %d', appthemes_get_user_total_unread_notifications( $dashboard_user->ID ) ); ?></span></a>
				</li>
				<li class="projects <?php hrb_dashboard_current_page_class('projects'); ?>">
					<a href="<?php echo esc_url( hrb_get_dashboard_url_for('projects') ); ?>"><?php echo __( 'Consultas', APP_TD ); ?></a><span>&nbsp;</span>
				</li>
		...
		<aside id="dashboard-acct-stats">
		 ...
		 <div class="section-head">
		   <h3><?php echo __( 'Estadísticas', APP_TD ); ?></h3>
		 </div>

		 <ul class="dashboard-stats">
		   <li class="rating">
			   <?php echo __( 'Clasificación', APP_TD ); ?>
		   ...
		   <li class="reviews-received">
			   <?php echo __( 'Reseñas recibidas', APP_TD ); ?>
		   ...
		   <li class="reviews-success_rate">
			   <?php echo __( 'Nivel de efectividad', APP_TD ); ?>
		...
		<aside id="dashboard-acct-info">
		  <div class="section-head">
			<h3><?php echo __( 'Información de cuenta', APP_TD ); ?></h3>
		  </div>

		  <ul class="links">
			  <li><?php echo __( 'Email público:', APP_TD ); ?></li>
