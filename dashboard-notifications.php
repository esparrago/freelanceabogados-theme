<h2><i class="icon i-notifications"></i><?php echo __( 'Notificaciones', APP_TD  ); ?></h2>
			...
			<form id="manage_notifications" name="manage_notifications" method="post" class="custom entry">
				...
				<table width="100%">
					<thead>
						<tr>
							<th width="5%">&nbsp;</th>
							<th width="70%" class="message"><?php echo __( 'Mensaje	', APP_TD ); ?></th>
							<th width="15%">&nbsp;</th>
				...
				<input id="bulk_delete" name="bulk_delete" type="submit" class="button small" value="<?php echo esc_attr__( 'Borrar seleccionadas', APP_TD ); ?>">
