...
add_theme_support( 'app-form-progress', array(
	'checkout_types' => array(
		'chk-create-project' => array(
			'steps' => array(
				'create-project' => array( 'title' => __( 'Detalles de la consulta', APP_TD ) ),
				'preview'		 => array( 'title' => __( 'Vista previa', APP_TD ) ),
				'select-plan'	 => array( 'title' => __( 'Options/Pay', APP_TD ) ),
				'thank_you'		 => array( 'title' => __( 'Gracias', APP_TD ) ),
				'order-summary'  => array( 'title' => __( 'Gracias', APP_TD ) ),
		...
		'chk-renew-project' => array(
			'steps' => array(
				'renew-project' => array( 'title' => __( 'Detalles de la consulta', APP_TD ) ),
                'preview'		 => array( 'title' => __( 'Vista previa', APP_TD ) ),
				'select-plan'	 => array( 'title' => __( 'Options/Pay', APP_TD ) ),
				'order-summary'  => array( 'title' => __( 'Gracias', APP_TD ) ),
				'gateway-select' => array( 'map_to' => 'select-plan' ),
